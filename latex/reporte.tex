...
Las rúbricas 24ICE04 y 24ICE05 fueron revisadas y se conservaron dentro del repositorio en \texttt{docs/rubricas/24ICE04.docx} y \texttt{docs/rubricas/24ICE05.docx}. Por eso el reporte incluye definición del problema, método, experimento, análisis, conclusiones, herramienta moderna, modelización y limitaciones.
...
\centering
\small
\caption{Matriz de cumplimiento de la rúbrica.}
\begin{tabular}{p{0.22\linewidth} p{0.66\linewidth}}
\toprule
Criterio & Evidencia en el proyecto\\
\midrule
Problema y relevancia & Se define el costo de subir imágenes crudas a un chat LLM y se justifica por ancho de banda, memoria, base64 y contexto.\\
Preguntas de investigación & Se plantean preguntas sobre ahorro, expansión base64 y pérdida numérica por compresión.\\
Método DSP & Se aplica remuestreo espacial, luminancia opcional, cuantización JPEG, MSE y PSNR.\\
Diseño experimental & Los parámetros controlables son calidad JPEG, dimensión máxima y luminancia; las respuestas medidas son bytes, PSNR, MSE y contexto estimado.\\
Análisis de datos & La interfaz y el reporte muestran bytes originales, bytes JPG, ahorro, relación de compresión, base64 evitado y PSNR.\\
Herramienta moderna & Se creó una app web con Vite, React, TypeScript y Tailwind, desplegada en Vercel y versionada en GitHub.\\
Limitaciones & Se documenta que JPEG no conserva transparencia, la compatibilidad depende del navegador y PSNR no sustituye validación semántica con un LLM real.\\
Mejoras & Se proponen OCR, SSIM y pruebas con modelos multimodales reales.\\
\bottomrule
\end{tabular}
\end{table}
